...
class SalesAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ("Organization", {"fields": ["instance", "entity", "unit"]}),
    ]
    list_display = ('sales_name', 'customer', 'project_value', 'expected_order_date', 'sales_status', 'project_manager', 'created_by', 'instance', 'entity', 'unit', 'created_at', 'updated_at')
